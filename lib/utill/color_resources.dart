...
class ColorResources {
  ...
  static const Color header_textColor = Color(0xff4aadd7);
  static const Color field_headerColor = Color(0xff225063);
  static const Color subtitle_textColor = Color(0xff2196f3);
